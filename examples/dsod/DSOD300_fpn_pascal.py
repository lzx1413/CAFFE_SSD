...
def AddExtraLayers(net, use_batchnorm=True, lr_mult=1):
    ...
    ConvBNLayer(net, "First",  "First_reduce", use_batchnorm, use_relu, 256, 1, 0, 1,
        lr_mult=lr_mult)
    ConvBNLayer(net, "Second",  "Second_reduce", use_batchnorm, use_relu, 256, 1, 0, 1,
        lr_mult=lr_mult)
    ConvBNLayer(net, "Third",  "Third_reduce", use_batchnorm, use_relu, 256, 1, 0, 1,
        lr_mult=lr_mult)
    net['Second_us'] = L.Interp(net['Second_reduce'],interp_param={'height':38,'width':38})
    net['Third_us'] = L.Interp(net['Third_reduce'],interp_param={'height':38,'width':38})   

    net['fea_concat'] = L.Concat(net['First_reduce'],net['Second_us'],net['Third_us'],axis = 1)
    #net['fea_concat_bn'] = L.BatchNorm(net['fea_concat'],in_place=True)
    ConvBNLayer(net,'fea_concat','fea_concat_bn_ds_1',use_batchnorm,use_relu,512,3,1,1,lr_mult=lr_mult)
...
save_dir = "models/DSOD300/VOC0712/{}_{}".format(job_name,date)
# Directory which stores the snapshot of models.
snapshot_dir = "ssd_models/DSOD300/VOC0712/{}_{}".format(job_name,date)
# Directory which stores the job script and log file.
job_dir = "jobs/DSOD300/VOC0712/{}_{}".format(job_name,date)
