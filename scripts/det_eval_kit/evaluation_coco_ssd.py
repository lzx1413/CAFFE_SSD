...
image_root = '/home/super/Database/MSCOCO/test2017/'
save_root = './predict_ss_coco_fpn/'
NUM_CLS = 81
...
parser.add_argument('--model_def',
                    default='ssd_models/COCO/deploy_VGG_coco_SSD_300x300_iter_400000.prototxt')
parser.add_argument('--image_resize', default=300, type=int)
parser.add_argument('--model_weights',
                    default='ssd_models/COCO/VGG_coco_SSD_300x300_iter_400000.caffemodel')
...
def eval_batch(detector,max_per_image=100, thresh=0.05):
    ...
    for i in xrange(eval_len - skip_num):
        test_img = image_root + eval_images[i + skip_num]
